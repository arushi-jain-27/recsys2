...
class triple2vec(Model):
    ...
    def __init__(self, DATA_NAME, HIDDEN_DIM, LEARNING_RATE, BATCH_SIZE, N_NEG, MAX_EPOCH=500, N_SAMPLE_PER_EPOCH=None, PATIENCE=5):
        super().__init__('triple2vec', DATA_NAME, HIDDEN_DIM, LEARNING_RATE, BATCH_SIZE, N_NEG, MAX_EPOCH, N_SAMPLE_PER_EPOCH, PATIENCE)
    ...
    def model_constructor(self, opt='sgd'):
        ...
        if opt == 'sgd':
            ...
            # tf.contrib is removed in TF2; fall back to Adam if unavailable
            try:
